...
namespace rannc {
    ...
    std::shared_ptr<torch::jit::Graph> trace(const py::tuple& input,
    ...
    std::unordered_map<std::string, torch::jit::IValue> matchParams(const std::shared_ptr<torch::jit::Graph>& graph,
