...
namespace rannc {
    ...
    public:
        GradConsolidation(ParamStorage* param_storage, std::vector<long> param_ids, bool use_amp_master_params,
                          bool consolidate_master_params);
        void consolidate();
    ...
    private:
        ...
        std::unordered_map<at::ScalarType, at::Tensor, EnumHash<at::ScalarType>> consolidated_grads_;
        std::unordered_map<long, at::Tensor> amp_master_grad_tensors_;
        std::unordered_map<at::ScalarType, at::Tensor, EnumHash<at::ScalarType>> consolidated_master_grads_;
    ...
    public:
        ...
        void useAmpMasterParams(const std::string& graph_id, bool use_amp_master_params);
    ...
    protected:
        ...
        std::unordered_map<std::string, std::unordered_map<long, std::unordered_set<int>>> my_param_ranks_;

        std::unordered_map<long, int> ref_counts_;

        std::unordered_map<long, at::Tensor> amp_master_params_;
        std::unordered_map<long, long> amp_param_id_map_; // master param -> model param
    ...
    private:
        ...
        std::unordered_map<std::string, std::unordered_map<int, std::shared_ptr<GradConsolidation>>> grad_cons_;
