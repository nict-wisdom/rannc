...
namespace rannc {
    ...
    struct MLEdge {
        ...
        friend std::ostream &operator<<(std::ostream &os, const MLEdge &edge) {
            os << "src_node: " << edge.src_id << " tgt_node: " << edge.tgt_id << " sub_edges: [" << edge.sub_edges
    ...
    using MLEdgeVectorMap = std::unordered_map<MLEdgeKey, std::vector<MLEdge>, MLEdgeKeyHash>;

    using GraphMergeKey = std::pair<int, int>;
    using GraphMergeKeyHash = IntPairHash;
    using GraphMergeCache = std::unordered_map <GraphMergeKey, std::shared_ptr<MLNode>, GraphMergeKeyHash>;
    ...
    struct MLGraphEdgeLabelWriter {
        ...
        void operator()(std::ostream& out, const boost::graph_traits<MLBGraph>::edge_descriptor& edge) const {
            write(out, edge);
        }
    private:
        void write(std::ostream& out, const boost::graph_traits<MLBGraph>::edge_descriptor& edge) const
        {
